...
Private assets stay in encrypted asset storage. License records, generation/edit manifests, moderation, export fidelity, and two-person publishing approval are retained as evidence.
